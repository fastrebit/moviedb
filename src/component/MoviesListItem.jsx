    ...
    return (
        <div className="movie">
            <img
                ...
                src={
                image ? "https://image.tmdb.org/t/p/original"+image : "../src/img/nullPhoto.jpg"
            }/>
            ...
            <Rate className={"movie__rate"} allowHalf count={10} defaultValue ={defaultValue} onChange={handleRateChange} style={{ fontSize: '16px' }}/>
        </div>
    );
};
